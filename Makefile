...
ft_strlcat.c ft_strchr.c ft_strlcpy.c ft_strrchr.c ft_strnstr.c ft_strncmp.c ft_atoi.c \
...
ft_lstnew.c ft_lstadd_front.c ft_listsize ft_lstlast.c ft_lstadd_back 
